import os
import shutil
import dump_to_species_converter_v26
import complexes_visualize_dev_v22 as complex_visualize
...
# call complexes_visualize_dev_v21_c_v02 by parsing the relevant arguments
        ...
        if s != '':
            ...
            try:
                if source['file_type'] == 'species':
                    ...
                    dump_to_species_converter_v26.dump_to_species(s, source_path, source['file_name'], 'save_species')
                    visualize = complex_visualize.complexes_vixualize(source_path, source['file_name'], des, adv)
                    if visualize:
                        complex_visualize.view(des + source['file_name'] + '_visualize.html')
